                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="mb-12">
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-300 to-pink-600 text-transparent bg-clip-text leading-tight">
                            Next-Gen<br />Code Reviews
                        </h1>
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                            Revolutionize your development workflow with AI-powered insights and enterprise-grade security
                        </p>
                        <Button
                            className="bg-gradient-to-r from-purple-500 to-pink-600 hover:scale-105 transform transition-all duration-200 text-lg px-8 py-6 rounded-full shadow-xl hover:shadow-purple-500/20"
                    ...
                    >
                        {[
                            ...
                            >
                                <div className={`w-14 h-14 rounded-2xl bg-${feature.color}-500/10 flex items-center justify-center mb-6 mx-auto group-hover:bg-${feature.color}-500/20 transition-colors`}>
